  ...
  return (
    ...
    <div>
        <div className="flex flex-col items-center justify-center min-h-[60vh] w-full text-center px-4"> 
          <h1 className="text-4xl font-bold text-gray-800 mb-8">Welcome to the e-Print Shop</h1> 
          <div className="relative inline-flex items-center justify-center gap-4 group"></div>
